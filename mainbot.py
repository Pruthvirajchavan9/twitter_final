...
while True:
    user = api.get_user('Pruthvi11698463')
    api.update_profile(name=f'Pruthvi|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Pruthvi|{follower_count(user)} Followers')
